...
export default function getPTImageIdInstanceMetadata(imageId: any) {
...
function convertInterfaceTimeToString(time: any) {
...
function convertInterfaceDateToString(date: any) {
